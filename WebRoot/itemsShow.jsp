    ...
    <div class="items">
        <div class="path">
            <p class="pathtext">
                ...
                <a class="patha" href="ItemsServlet?category=<%=category %>&type=<%=type %>"><%=type %></a>
            </p>
        </div>
        <div class="left">
            <ul>
        ...
        <div class="page">
            <ul class="pagination">
                <% 
         			...
         			{ 
				%>
		    			<li><a href="ItemsServlet?category=<%=category %>&type=<%=type %>&pageNow=<%=pageNow-1%>">«</a></li>
				<%
		    			for(int i=1;i<=pageCount;i++)
		    			{
				 %>
		    	 			<li><a href="ItemsServlet?category=<%=category %>&type=<%=type %>&pageNow=<%=i%>"><%=i%></a></li>
		    	 	<% 	}%>
		    	 ...
		    	 <% 
		    		...
		    		{
		    	%>
		    			<li><a href="ItemsServlet?category=<%=category %>&type=<%=type %>&pageNow=1">«</a></li>
				<% 
		    			for(int i=1;i<=pageCount;i++)
		    			{
		    	%>
		    	...
		    	%>
		    	 			<li><a href="ItemsServlet?category=<%=category %>&type=<%=type %>&pageNow=<%=i%>"><%=i%></a></li>
		    	 	<% 	}%>
		    	   			<li><a href="ItemsServlet?category=<%=category %>&type=<%=type %>&pageNow=<%=pageCount%>">»</a></li>
		    	<% 	}%>
            </ul>
        </div>
    </div>
